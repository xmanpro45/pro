...
check /help for more.""",
                             reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Bots Channel", url=f"https://t.me/+hQxLdoWPyfQ1M2Q1"),
                                                                 InlineKeyboardButton("Support Group", url=f"https://t.me/Vvip_BD")]]),
...
for more help ask at @Jhondev_xd""",
                             reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Bots Channel", url=f"https://t.me/+hQxLdoWPyfQ1M2Q1"),
                                                                 InlineKeyboardButton("Support Group", url=f"https://t.me/vvip_bd")]]),
                             disable_web_page_preview=True)
